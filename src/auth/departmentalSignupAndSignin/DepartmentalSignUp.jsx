...
export default function DepartmentalSignUp() {
        ...
        <div className="p-3">
          ...
          <form className="flex flex-col gap-y-5">
            <div className="bg-white rounded-md  p-2 flex flex-col gap-y-5 ">
              <input
                type="text"
                placeholder="Department Admin Full name "
                required
                disabled={isLoading}
    ...
    <div className="p-3">
      ...
      <form >
        ...
        //   disabled={schoolLoading}
          className={`${
            disabled ? "bg-secondary400" : "bg-secondary600"
