          ...
          <nav className="px-6 py-2 bg-[#FAFAFA80] rounded-full md:w-[600px] md:mx-auto">
            <div className="flex justify-between items-center">
              ...
              <div className="md:flex gap-x-4 items-center hidden ">
                <Link to="/signin" className="text-black capitalize">
                  login
                </Link>
                <Link
                  to="/signup"
                  className="capitalize bg-secondary600 py-1 tracking-wide px-4 rounded-md text-white"
                >
                  sign up
                </Link>
              </div>
...
>
  ...
  />
          ...
          <div className="mt-3 relative ">
            ...
            />
            {/* <div className="h-[20rem] w-[20rem] bg-stone-100  rounded-full absolute z-[1] right-[-4rem] top-[-1rem]"></div> */}
          </div>
        </div>
        {/* </div> */}
      </header>
