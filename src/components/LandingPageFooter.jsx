  ...
  return (
    <footer className="py-3 px-4 bg-stone-50 divide-y border-t-[0.5rem] border-t-secondary700 divide-stone-500">
      <div className="flex flex-col mb-6 gap-y-2 ">
        <div className="flex gap-x-2 mb-10 items-center md:justify-center md:pt-4">
        ...
        <button
          ...
          className="bg-secondary600 font-medium md:w-[400px] mx-auto w-full p-2 py-3 rounded-md text-center text-white"
        >
          Sign up
        </button>
      </div>
