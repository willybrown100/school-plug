...
import SugNavlinks from './SugNavlinks';
    ...
    const links = [
      {
        ...
        path: "/departmentalhome/depthome",
      },

      {
        name: <span className="lg:hidden"> events</span>,
        icon: (
          <svg
            width="24"
            height="24"
          ...
          >
            ...
            <path
              ...
              strokeMiterlimit="10"
              className={`${
                pathname === "/departmentalhome/deptevent" ? "pz" : "black"
              }`}
            />
            <path
              d="M2 2.5H22"
        ...
        path: "/departmentalhome/deptevent",
      },
