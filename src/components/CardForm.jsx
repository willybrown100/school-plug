...
mutate(formData)
  ...
  return (
    <div className="bg-white p-4 rounded-lg pt-[7rem] shadow-md mx-auto md:w-1/2 pb-[5rem]">
      ...
      <img src="\images\progressbar2.png" alt="img" className="mb-6" />
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          ...
          className={
            isButtonDisabled
              ? "bg-[#B8CFF3] text-[#FAFAFA] py-3 px-[70px] rounded w-full font-bold"
              : "bg-[#2B70DB] text-white py-3 px-[70px] rounded w-full font-bold"
          }
        >
          {isLoading ? (
