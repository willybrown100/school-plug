  ...
  return (
    ...
    <Navbar/>
      ...
      <article className="min-h-screen max-lg:grid px-3 max-lg:place-items-center ">
        ...
        <div className="min-h-screen lg:flex items-center justify-center hidden ">
          <div className="hidden lg:flex justify-between gap-x-40 items-center">
            <div className=" flex flex-col gap-y-2">
              <h4 className="text-secondary500 font-semibold">404 error</h4>
              <h2 className="font-semibold">Page not found</h2>
              <p className="text-stone-700 ">
                Sorry, the page you are looking for does not exist. Here are
                some helpful links:
              </p>
