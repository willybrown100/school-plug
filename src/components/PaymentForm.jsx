...
const levels = ['Choose Level', 'Level 1', 'Level 2', 'Level 3', 'Level 4']; // Include default option
    ...
    return (
        <div className="bg-white p-4 rounded-lg shadow-md w-full max-w-md">
            ...
            <form onSubmit={handleSubmit}> {/* Add onSubmit to the form */}
                ...
                {selectedFee ? (
                    <div className="flex items-center border px-3 pt-2 mb-4 rounded-lg outline outline-1 outline-blue-500 w-1/2">
